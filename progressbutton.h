...
class ProgressButton : public QPushButton
{
    ...
    Q_PROPERTY(QColor progressColor READ progressColor WRITE setProgressColor DESIGNABLE true)
    Q_PROPERTY(int progressLineWidth READ progressLineWidth WRITE setProgressLineWidth DESIGNABLE true)
